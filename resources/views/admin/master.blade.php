    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.html"><img class="main-logo" src="{{ asset('images/icons/transferir.jpeg') }}" style="width: 200px; margin-top: 65px;" alt="" /></a>
                <strong><img src="{{ asset('images/icons/transferir.jpeg') }}" style="width: 200px; margin-top: 65px;"></strong>
            </div>
                    ...
                    <ul class="metismenu" id="menu1">
                        <li class="active">
                            ...
                            <ul class="submenu-angle" aria-expanded="true">
                                <li><a title="Product List" href="{{ url('admin/categories') }}"><span class="mini-sub-pro">Categoria</span></a></li>
                                <li><a title="Product Edit" href="{{ url('/admin/products') }}"><span class="mini-sub-pro">Productos</span></a></li>
                                <li><a title="Product Cart" href="product-cart.html"><span class="mini-sub-pro">Pedidos</span></a></li>
