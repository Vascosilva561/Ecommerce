...
<body>
    <header class="clearfix">
        <div class="container">
            <div>
                <img src="{{ public_path() }}/images/icons/logo-shopp.png" style="width: 140px; height: 60px;">
            </div>
                ...
                <table>
                    <tbody class="head">
                        <tr>
                            <th class="no"></th>
                            <th class="desc">
                                <div style="margin-left: 120px;">Description</div>
                            </th>
                            <th class="qty">
                                <div>Quantidade</div>
                            </th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="grand-total" colspan="5">
                                <div><span>TOTAL:</span>{{ presentPrice(Cart::total()) }} Kz</div>
                            </td>
                        </tr>
                    </tbody>
                </table>
