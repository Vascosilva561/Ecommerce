				...
				<div class="container">
					...
					<form action="{{ url('updatePassword') }}" method="post" role="form" multpart="">
						...
						<div class="form-group {{$errors->has('oldPassword')?'has-error':''}}" >
							...
							<input type="text" class="form-control" name="oldPassword" id="oldPassword" placeholder="">
						...
						<div class="form-group {{$errors->has('newPassword')?'has-error':''}}" >
							...
							<input type="text" class="form-control" name="newPassword" id="newPassword" placeholder="">
