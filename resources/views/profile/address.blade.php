				...
				<div class="container">
					...
					<form action="{{ url('updateAddress') }}" method="post" role="form" multpart="">
						...
						<div class="form-group {{$errors->has('name')?'has-error':''}}" >
							...
							<input type="text" class="form-control" name="name" value="{{$value->name}}" id="fullname" placeholder="">
						...
						<div class="form-group {{$errors->has('endereco')?'has-error':''}}" >
							...
							<input type="text" class="form-control" name="endereco" value="{{$value->endereco}}" id="endereco" placeholder="">
							...
							<input type="text" class="form-control" name="ponto_referencia" value="{{$value->ponto_referencia}}" id="ponto_referencia" placeholder="">
							<span class="text-danger">{{$errors->first('ponto_referencia')}}</span>
						</div>

							<div class="form-group {{$errors->has('telefone')?'has-error':''}}" >
							<label for="telefone"></label>
							<input type="text" class="form-control" name="telefone" value="{{$value->telefone}}" id="telefone" placeholder="">
							<span class="text-danger">{{$errors->first('telefone')}}</span>
						</div>

						<div class="form-group {{$errors->has('pais')?'has-error':''}}" >
							<label for="pais"></label>
							<input type="text" class="form-control" name="pais" value="{{$value->pais}}" id="pais" placeholder="">
