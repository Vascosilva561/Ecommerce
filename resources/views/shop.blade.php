								...
								<ul class="standard_dropdown main_nav_dropdown">
									...
									<li class="hassubs">
										...
										<ul>
											...
											<li><a href="{{ url('/') }}/profile" style="color: #952825;" class="efect">Perfil<i class="fas fa-chevron-down"></i></a></li>
	            ...
	            @endif
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							<div class="shop_product_count"><span style="color: #a12421;"> {{ $total_counts }} </span> - Productos Encontrado</div>
							<div class="shop_sorting">
								<span>Liltrar Por:</span>
								<a href="{{ route('shop.index', ['category' => request()->category, 'sort' => 'low_high']) }}"> Preços Baixio </a> || 
								<a href="{{ route('shop.index', ['category' => request()->category, 'sort' => 'high_low']) }}">Preços Alto </a>
								<ul>
									<li>
										...
										<ul>
											...
											<li class="shop_sorting_button" data-isotope-option='{ "sortBy": "original-order" }'>Destaque</li>
						...
						<div class="product_grid">
							...
							@forelse ($products as $product)
								<div class="product_item is_new">
									...
									<div class="product_image d-flex flex-column align-items-center justify-content-center"><a href="{{ route('shop.show', $product->id) }}" tabindex="0"><img src="{{ asset('images/product/'.$product->image) }}" style="width: 150px; height: 150px;" alt=""></a></div>
									<div class="product_content">
										<div class="product_price">{{ $product->presentPrice() }}kz</div>
										<div class="product_name"><div><a href="{{ route('shop.show', $product->id) }}" tabindex="0" style="color: #a12421; font-size: 12px;"><b>{{ $product->name }}</b></a></div></div>
									</div>
