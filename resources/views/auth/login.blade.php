            ...
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="POST" action="{{ route('login') }}" aria-label="{{ __('Login') }}">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Valid email is: a@b.c">
                        ...
                        <span class="focus-input100" for="email" data-placeholder="{{ __('E-Mail Address') }}"></span>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                        ...
                        <input class="input100{{ $errors->has('password') ? ' is-invalid' : '' }}" id="password" type="password" name="password">
