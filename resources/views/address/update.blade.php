                ...
                <div class="col-lg-10 offset-lg-1">
                    <div class="cart_container">
                        <div class="cart_title">
                            <center>Actualizar o Endereço: {{ $addres->name }}</center>
                        </div>
                        ...
                        <form action="{{ route('address.update', $addres->id) }}" method="post">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="text" name="name" class="form-control" id="inputEmail4"
                                        placeholder="nome" value="{{ $addres->name }}" readonly>
                                </div>

                                <div class="form-group col-md-6">
                                    <label for="inputPassword4">email</label>
                                    <input type="email" name="email" class="form-control" id="inputPassword4"
                                        placeholder="email" value="{{ $addres->email }}" readonly>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="endereco" class="form-control" id="inputAddress"
                                    placeholder="morada" value="{{ $addres->endereco }}">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ponto_referencia" class="form-control" id="inputAddress2"
                                    placeholder="Apartment, studio, or floor" value="{{ $addres->ponto_referencia }}">
                            </div>

                            <div class="form-group">
                                <label for="inputAddress2">País</label>
                                <input type="text" name="pais" class="form-control" id="inputAddress2"
                                    placeholder="País" value="{{ $addres->pais }}">
                            </div>
