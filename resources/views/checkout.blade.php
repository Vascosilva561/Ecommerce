                                ...
                                <tr>
                                    ...
                                    <td>
                                    	<div class="cart_item_text">
											<div class="cart_item_text"><p style="color: black;"><b>{{ $item->model->name }}</b></p></div>
										</div>
                                    	
                                    </td>

                                    <td>
                                    	<div class="cart_item_text"><p style="color: black;"><b>EM STOCK</b></p></div>
									</td>

                                    <td>
                                    	<div class="cart_item_text">
											<div class="cart_item_text"><p style="color: black;"><b>{{ $item->qty }}</b></p></div>
										</div>
									</td>
...
<br>
							...
							<div class="cart_buttons" align="center">
								...
								<a href="{{ url('faturaProforma') }}"  class="btn btn-warning btn-lg" style="width: 500px; margin-right: 700px; background: linear-gradient(to bottom, #003366 0%, #666633 100%);"><B>PAGAR POR TRANFERENCIA BANCARIA</B></a>
								{{-- <a href="{{ route('formpaymant.formasPagamento') }}"  class="btn btn-warning btn-lg">Forma de Pagamento</a> --}}
								<a href="{{ route('resumo.create') }}"  class="btn btn-warning btn-lg" style="width: 550px; margin-top:-80px; background: linear-gradient(to bottom, #ff0000 0%, #ff9933 100%);"><B>PAGAR POR REFERENÇIA MULTICAIXA</B></a>
							</div>
						</div>
					</div>
				</div>
