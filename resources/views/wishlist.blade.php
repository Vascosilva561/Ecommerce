							...
							@foreach ($products as $product)
								...
								<div class="product_item is_new">
									...
									<div class="product_content">
										...
										<div class="product_name"><div><a href="{{ route('shop.show', $product->id) }}" tabindex="0" style="color: #a12421; font-size: 11px;"><b>{{ $product->name }}</b></a></div></div>
									</div>
										<form action="{{ route('cart.store') }}" method="POST">
						                            ...
						                            </form><a href="{{ url('/') }}/removeWishList/{{$product->id}}" style="color: red;" class="btn btn-default btn-block">Remover desejado</a>
